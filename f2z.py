...
class F2Z(object):
    ...
    def zendesk_post_ticket(self, fd_ticket):
        ...
        d['tags'] = [
            ...
            'source-{}'.format(fd_ticket['source_name']),
            'freshdesk-import',
        ]
        ...
        if attachments:
            ...
            for attachment in attachments[:1]:
                ...
                urlretrieve(content_url, '/Users/ivanthai/temp/temp.JPG')
                response = post(
                ...
                # request = urllib2.Request(
                #     url=self.freshdesk_base_url + '/api/v2/uploads.json',
                ...
                # )
                j = response.json()
                to_attach.append(j['upload']['token'])
            # d['uploads'] = to_attach
...
if __name__ == '__main__':
    freshdesk_company = 'voyajoyinc'
    freshdesk_username = 'ivan@voyajoy.com'
    freshdesk_pw = 'M1sos0up312'

    zendesk_company = 'voyajoyone'
    zendesk_username = 'ivan@voyajoy.com'
    zendesk_pw = 'M1sos0up312'
